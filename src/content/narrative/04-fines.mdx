...
export const dtc = finesLayer.channels.find(c => c.channel_type === 'DTC');
...
<div class="dtc-stat">
  <p class="dtc-label">DTC — After Compliance Fines</p>
  <p class="dtc-value">{formatCompact(dtc?.value || 0)}</p>
  <p class="dtc-note">Unchanged — no retail partner to fine</p>
</div>
